...
* Q5: creates a KG-OLAP cube of the topic family \emph{EnRoute} for the territory of France during the year 2000. The resulting cube contains 4392 contexts or 177144 quads.
...
* Q6: creates a KG-OLAP cube of the topic family \emph{ EnRoute} for the territory of France during the year 2000 and rolls up topic, location, and time to all. The resulting cube contains 1 contexts or 83448 quads.
...
* Q7: creates a KG-OLAP cube of the topic category \emph{Routes} and the location FIR \emph{LOVV} during the year 2000. The resulting cube contains 4392 contexts or 166164 quads.
...
* Q8: creates a KG-OLAP cube of the topic category \emph{Routes} and the location FIR \emph{LOVV} during the year 2000 and is added from topic to category, location to location, and time to month. The resulting cube contains 36 contexts or 128304 quads.
